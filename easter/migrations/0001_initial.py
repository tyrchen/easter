...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'easter_user_profile', (
        ...
        db.send_create_signal(u'easter', ['UserProfile'])

    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'easter_user_profile')
    ...
    models = {
        ...
        u'easter.userprofile': {
            'Meta': {'object_name': 'UserProfile', 'db_table': "u'easter_user_profile'"},
