...
DATABASES = {
  'default': {
    ...
    'NAME': 'easter.db',                      # Or path to database file if using sqlite3.
...
AUTH_PROFILE_MODULE = 'easter.UserProfile'
...
AUTHENTICATION_BACKENDS = (
  'easter.backends.auth_backend.UserProxyBackend',
)


CUSTOM_USER_MODEL = ('easter', 'User')
...
CELERY_IMPORTS = ('easter.tasks.crons', )
...
LOGGING_HANDLER = 'easter.utils.log.RotatingFileHandler'
...
LOGGING = {
  ...
  'handlers': {
    ...
    'mail_admins': {
      'level': 'ERROR',
      'class': 'easter.utils.admin_mail.AdminEmailHandler',
      'include_html': True,
      },
    'main': {
      'level': LOGGING_LEVEL,
